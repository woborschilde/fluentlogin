          ...
          <div class="widget widget-table action-table">
            ...
            {nocache}
              <div class="widget-content">
                <br />
                <div class="alert alert-success" style="margin: auto; padding: 15px; width: 80%; text-align: center;">
                  <i class="shortcut-icon icon-ok"></i><br />
                  <h2>Congratulations!</h2><br />
                  <b>You're all set!</b><br />
                  <br />
                  Setup has finished the installation process.<br />
                  You can now use your new fluentlogin installation.<br />
                  <br />
                  <a href="../admin/login.php" class="btn btn-success">Log in to admin panel ></a>
                </div>
                <br />
              </div>
            {/nocache}
