<?php
	...
	*/
    ...
    $query = $conn->query("SELECT appID, serviceName FROM fl_apps_services WHERE serviceType='mybb18'");  // <== write here
    ...
    db_del("fl_plugins", "pluginName='service.mybb18'", __FILE__, __LINE__);
    db_sel("typeID", "fl_servicetypes", "typeName='mybb18'", __FILE__, __LINE__);
    db_del("fl_servicetypes", "typeName='mybb18'", __FILE__, __LINE__);
