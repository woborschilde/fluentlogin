        ...
        <div class="span6" style="width: 100%;">
          <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-list-alt"></i>
              {nocache}
                <h3>{$appName} > Benutzergruppe {$actionName}</h3>
              {/nocache}
            </div>
            <!-- /widget-header -->
            {nocache}
                ...
                <br />
                  <form id="groupEdit" class="form-horizontal" style="margin-bottom: 0px;" onsubmit="editgroup({$appID}, {$groupID}); return false;">
                    <fieldset>
                      ...
                      <div class="control-group">
                        <label class="control-label" for="groupDescription">Beschreibung:</label>
                        <div class="controls">
                      ...
                      <div class="panel panel-danger" style="margin-left: 2%; width: 60%;">
                        <div class="panel-heading">Berechtigungen für diese Benutzergruppe</div>
                        <div class="panel-body">
                          {foreach from=$keys item=i}
                            ...
                            {else}
                              {$permNames[$i]} <a href="permissionEdit.php?appID={$appID}" target="_blank"><u>Erstellen</u></a>
                            {/if}
                          {/foreach}
                        </div>
                      </div>
